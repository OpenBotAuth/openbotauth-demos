...
router.post('/checkout', async (req, res) => {
  try {
    ...
    // Use PUBLIC_URL from config (set for production deployment)
    const verifyRequestUrl = `${config.publicUrl}${req.originalUrl}`;
    console.log('[Merchant] Verify URL:', verifyRequestUrl);
